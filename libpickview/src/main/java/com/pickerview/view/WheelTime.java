...
class WheelTime {
	...
	public String getTime() {
		return String.valueOf((wv_year.getCurrentItem())) + "-" + (wv_month.getCurrentItem()) +
				"-" + (wv_day.getCurrentItem()) + " " + wv_hours.getCurrentItem() +
